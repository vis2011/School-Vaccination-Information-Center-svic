class homePage {
  ...
  setPosition() {
    ...
    this.welcomeText.position(width / 2 - 460, height / 2 - -550);
    this.loginText.position(width / 2 - 195, height / 2 - -700)
    this.signUpText.position(width / 2 - 130, height / 2 - -850)
    this.loginButton.position(width / 2 - 30, height / 2 - -780);
    this.signUpButton.position(width / 2 - 30, height / 2 - -925);
  }
  setElementsStyle() {
