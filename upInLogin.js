class userpasswordil {
    ...
    setElementPosition() {
        this.NextButton.position(width / 2 - -10, height / 1 - -660);
        this.BackButton.position(width / 2 - 200, height / 1 - -660);
        this.PasswordInput.position(width / 2 - 160, height / 2.14 - -810);
        this.usernameInput.position(width / 2 - 160, height / 2.14 - -700);
        this.uptitle.position(width / 2 - 230, height / 2 - -470);
        this.u.position(width / 2 - 160, height / 2 - -630);
        this.p.position(width / 2 - 160, height / 2 - -740);
        this.eyeClose.position(width / 2 - -130, height / 2.14 - -825);
        this.eyeOpen.position(width / 2 - -130, height / 2.14 - -825);
        this.texts1.position(width / 2 - 660, height / 2.14 - -700);
        this.texts2.position(width / 2 - 160, height / 2.14 - -700);
        this.texts3.position(width / 2 - 660, height / 2.14 - -810);
        this.texts4.position(width / 2 - 160, height / 2.14 - -810);
        this.texts5.position(width / 2 - 660, height / 1 - -660);
        this.texts6.position(width / 2 - 160, height / 1 - -660);
    }
                ...
                for (var i = 0; i < users.length; i++) {
                    if (this.UName=== users[i].Username && this.PName== users[i].Password) {
                        ...
                        Swal.fire({
                            ...
                            icon: 'success',
                            timer: 1000,
                            text: 'Authentication sucecessful',
                        })
