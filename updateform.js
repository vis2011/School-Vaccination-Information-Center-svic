class updateForm {
    ...
    setElementsStyle() {
        ...
        this.input.class("customInput3");
        this.input1.class("customInput3");
        this.input2.class("customInput3");
        this.input3.class("customInput3");
        this.input4.class("customInput3");
        this.input5.class("customInput3");
        this.input6.class("customInput3");
